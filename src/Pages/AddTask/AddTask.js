...
const AddTask = () => {
  ...
  return (
    <div className="md:w-[50%] lg:w-[33%] mx-auto p-10 pt-0">
      ...
      >
        ...
        <button
          type="submit"
          value="Submit"
          className="w-full text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 uppercase"
        >
          Submit
        </button>
      </form>
